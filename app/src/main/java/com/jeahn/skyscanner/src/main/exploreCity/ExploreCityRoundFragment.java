...
public class ExploreCityRoundFragment extends Fragment implements ExploreCityActivityView {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_explore_city_round, container, false);

        mRecyclerView = v.findViewById(R.id.explore_city_round_recycler);
    ...
    private void tryGetFlightList() {
        ...
        flightsService.getFlightList("R", "GMP", "대한민국");
    }
    ...
    public void getFlightListFailure(String message) {
        ((BaseActivity)getActivity()).showCustomToast("도시별 왕복 최저가 조회 실패");
    }
